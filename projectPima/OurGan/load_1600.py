...
if __name__ == "__main__":
    ...
    generator.load_weights('./output_1600/gan_convolutional/generator.h5')
    discriminator.load_weights('./output_1600/gan_convolutional/discriminator.h5')
    ...
    mpl.pyplot.savefig('Image_1600_generer_1')
    mpl.pyplot.colorbar()
    mpl.pyplot.show()
    ...
    mpl.pyplot.savefig('Image_1600_generer_2')
    mpl.pyplot.colorbar()
    mpl.pyplot.show()

    y_filtred = yy[1][3]
    mpl.pyplot.imshow(y_filtred)
    mpl.pyplot.savefig('Image_1600_generer_3')
    mpl.pyplot.colorbar()
    mpl.pyplot.show()
        
    y_gauss1 = yy[1][7]
    mpl.pyplot.imshow(y_gauss1)
    mpl.pyplot.savefig('Image_1600_generer_4')
    mpl.pyplot.colorbar()
    mpl.pyplot.show()
