...
if __name__ == "__main__":
    ...
    df.to_csv("output_600/gan_convolutional/history.csv")

    generator.save("output_600/gan_convolutional/generator.h5")
    discriminator.save("output_600/gan_convolutional/discriminator.h5")
